    ...
    extends Service
{
    ...
    static {
        ...
        try {
            url = new URL("http://localhost:8080/Turtles/services/GameService?wsdl");
    ...
    public GameService getGameServicePort() {
        return super.getPort(new QName("http://Services/", "GameServicePort"), GameService.class);
    }
    ...
    public GameService getGameServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://Services/", "GameServicePort"), GameService.class, features);
    }
